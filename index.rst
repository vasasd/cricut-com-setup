...
.. meta::
   :description: Cricut.com/setup is the promary web url for cricut new and old device installation.
   
.. title::
    Cricut.com/Setup - Setup Cricut Device On Various Platforms

=========================================
**Cricut.com/setup**
=========================================
**Cricut.com/setup** is an easy option to cut designs with your hands manually. The craftwork and large design tasks are completed by Cricut. The handmade designs lack the finishing but the designs cut by the Cricut machines are precise as per the designs on the design space application.

|
.. image:: cricut-setup.jpg
    :width: 300px
    :align: center
    :height: 90px
    :alt: cricut.com/setup
    :target: https://termilo.com/ref.php?i=b2ccc05d-66af-40cc-8674-16eb68418902
|
Also, the user of cricut maker machine gets a design space application that makes inserting the templates and editing work easy. Not only the working of the Cricut machine but the setup of it is also quite important. So here is the guide to set up your purchased Cricut machine.

##################
Let's setup the **"Cricut.com/setup"** machine
##################
...
- Directly visit the official website of Cricut i.e. **cricut.com/setup windows**.
...
1. Go to the Downloads folder or the download location of the same browser.
2. Then either press double click or a single click.
3. Then give permission to install the design space application by pressing the Yes button.
4. Now, wait for the initialization and the installation.
5. The installation will take automatically and then open the application.
6. If the update for the application is available then update it immediately.
7. This will take some time.
8. Now restart your system.
9. Follow the same process for the MAC operating system.

##################
Cricut Setup On Windows
##################
For some devices such as the mobile handset, you need to connect the device using the Bluetooth connection. For that;
1. Open the Bluetooth settings of your handset.
2. Go to the available devices option.
3. Select the Cricut Bluetooth connection.
4. Press and pair it up.
5. This is the Bluetooth connection of `cricut.com/setup <https://cricut-com-setup.readthedocs.io/en/latest/index.html>`_.
